function beh_data = Behavior_extract(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DSEX3231600MS701BOX1ANALOG = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   DSEX3231600MS701BOX1ANALOG = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   dsex3231600ms701box1analog = importfile('dsex32-3-1600ms7-01-box1-analog.csv', 1, 1794340);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/08/15 14:28:41
